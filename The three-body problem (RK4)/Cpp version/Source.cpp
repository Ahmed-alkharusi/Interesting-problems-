...
Matrix deriv(Matrix obj_active, Matrix obj_passive1, const double& mp1, Matrix obj_passive2, const double& mp2);
void rk4(Matrix(*deriv)(Matrix, Matrix,const double&, Matrix, const double&), Matrix &obj_active, Matrix &obj_passive1,const double &mp1, Matrix &obj_passive2,const double &mp2, const double &h);
void implement_rk4(Matrix(*deriv)(Matrix, Matrix, const double&, Matrix, const double&),Matrix &obj_1,const double &m1,Matrix &obj_2,const double &m2, Matrix &obj_3, const double &m3,double &t, const double &step_size, const long unsigned int &steps_no, std::vector<std::vector<std::vector<double>>> &result_obj1, std::vector<std::vector<std::vector<double>>> &result_obj2, std::vector<std::vector<std::vector<double>>> &result_obj3);
